            ...
            <div class="mt-6 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                <div class="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">
                    <div class="md:flex">
                        <div class="p-6">
                            <div
                                class="uppercase tracking-wide text-sm text-indigo-500 font-semibold">{{ $post['title'] }}</div>
                            <a href="#"
                               class="block mt-1 text-lg leading-tight font-medium text-black hover:underline">{{ $post['id'] }}</a>
